...
### Added
- Track headings on Edit journal and View journal are clickable and navigate to the track in Analytics view

### Changed
- Removed labels on View journal
- Bumped dependencies
- Improved test scripts

### Fixed
- Button variant applied correctly
- Chart options types
